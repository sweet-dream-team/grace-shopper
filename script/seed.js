...
async function seed() {
  ...
  const products = await Promise.all([
    Product.create({
      ...
      duration: 7,
      imageURL:
        "http://www.image.farm/images/2021/04/21/3eb9d2d0fa4d20f85dc7351a930cdbd9.png",
      stockQuantity: 5,
    }),
    Product.create({
      ...
      duration: 5,
      imageURL:
        "http://www.image.farm/images/2021/04/21/214c5930e2e3e1758cdd6ad674d73d33.png",
      stockQuantity: 5,
    }),
    Product.create({
      ...
      duration: 3,
      imageURL:
        "http://www.image.farm/images/2021/04/21/46ff1252168da0d179c01f79f2dfe786.png",
      stockQuantity: 5,
    }),
    Product.create({
      ...
      duration: 9,
      imageURL:
        "http://www.image.farm/images/2021/04/21/8228073375a90f5bc2894ac1fc5237af.png",
      stockQuantity: 5,
    }),
    Product.create({
      ...
      duration: 6,
      imageURL:
        "http://www.image.farm/images/2021/04/21/fc6b88750874396c545c0f75b7d48477.png",
      stockQuantity: 5,
    }),
    Product.create({
      ...
      duration: 3,
      imageURL:
        "http://www.image.farm/images/2021/04/21/16f3e27db0202da3cf6e36e1861d2ad5.png",
      stockQuantity: 5,
    }),
    Product.create({
      ...
      duration: 8,
      imageURL:
        "http://www.image.farm/images/2021/04/21/b272a5e72348a56cc0136eb16d2d9133.png",
      stockQuantity: 10,
    }),
    Product.create({
      ...
      duration: 5,
      imageURL:
        "http://www.image.farm/images/2021/04/21/22d29e4786b1eb36d93c7dbe226001f6.png",
      stockQuantity: 10,
    }),
    Product.create({
      ...
      duration: 3,
      imageURL:
        "http://www.image.farm/images/2021/04/21/a2e45a67cab55fcbae6491f08323f2f4.png",
      stockQuantity: 10,
    }),
    Product.create({
      ...
      duration: 9,
      imageURL:
        "http://www.image.farm/images/2021/04/21/c37fd4fb6b07254e76e971ea939a99a1.png",
      stockQuantity: 10,
    }),
  ]);
